...
hop2 = 12;
idx = meta_data.hop_ID == hop1; channel_names = meta_data.link_name(idx); cn1 = char(channel_names(1));
idx = meta_data.hop_ID == hop2; channel_names = meta_data.link_name(idx); cn2 = char(channel_names(1));
...
%%
    ...
    u.show_hops_on_map (valid_hops, meta_data, true);
